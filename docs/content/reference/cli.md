...
```
cheapshark <command> [arguments] [flags]
```

Run `cheapshark <command> --help` for the full flag list on any command. This
...
per operation you declare in `cheapshark/domain.go`.
