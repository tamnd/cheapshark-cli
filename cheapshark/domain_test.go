...
// HTTP behaviour is covered in cheapshark_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cheapshark://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cheapshark", "about")
	if err != nil || got.String() != "cheapshark://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cheapshark://page/about", got.String(), err)
	}
}
