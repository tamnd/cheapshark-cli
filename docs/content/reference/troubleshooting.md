...
Most of these come down to network reality or how cheapshark serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cheapshark rate-limits like any public site. cheapshark already paces
...
Where a surface is gated, cheapshark reads a cookie or token you supply
...
`cheapshark`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cheapshark actually did
